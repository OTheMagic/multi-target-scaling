...
Sample sizes and model settings are specified below. Across-repetition variability and
...
marks the target coverage $0.9$; numerical results and standard deviations
are reported in Table~\ref{tab:gaussian-heter}.}
...
coverage and residual-space volume over 200 repetitions. The dashed line
marks the target coverage $0.9$; numerical results and standard deviations
are reported in Table~\ref{tab:gaussian-homo}.}
