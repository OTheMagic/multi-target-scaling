...
% AUTHOR-CHECK DATA: Archived CSV provenance remains unverified against the independent-redraw design.
...
% AUTHOR-CHECK TIES: Capping enforces nonnegativity but does not establish the standing distinctness assumption.
Capping can introduce ties at zero, so these empirical results do not by
themselves establish the distinctness condition in
Assumption~\ref{eq:assumption-scores}.
...
% AUTHOR-CHECK REPRO: Verify the environment and package versions for these historical timing records.
