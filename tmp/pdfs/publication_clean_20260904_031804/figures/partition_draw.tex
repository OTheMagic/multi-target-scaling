...
% BEGIN SCHEMATIC ANNOTATION R2m3
  \draw[blue, thick] (\vone,-0.12) -- (\vone,0.12);
  \node[below=3pt, text=blue, font=\normalsize] at (\vone,-0.12) {$\mathcal{L}_1$};
  \draw[blue, thick] (-0.12,\vtwo) -- (0.12,\vtwo);
  \node[left=3pt, text=blue, font=\normalsize] at (-0.12,\vtwo) {$\mathcal{L}_2$};
% END SCHEMATIC ANNOTATION R2m3
