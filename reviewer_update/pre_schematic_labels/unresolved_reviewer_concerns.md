...
Total: **11 addressed, 5 partially addressed, 4 open**. The editor's overall completion and manuscript-wide color-marking requests remain partial until the open items are resolved and the final submission is audited.
